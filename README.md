# Practical AI for Research: LLMs and Unstructured Data

**ERIM Summer School 2026 · 13, 15, 17, 20 July · Dr. Vahid Moghani**

This is the course repository. If you're reading this on the course's own page, your first move is on Canvas: the **Block 0 setup guide** walks you through making *your own private copy* of this repo (the green **Use this template** button) and everything else — in about 45 minutes, no installation, no admin rights.

## What's in here

| Folder | What it is | You'll use it in |
|---|---|---|
| `a1/` | Five abstracts + the starting prompt for Assignment 1 | A1 |
| `a2/` | The three prompt patterns for Assignment 2 | A2 |
| `data/` | The synthetic survey (1,200 rows), the concern codebook, the fixed 200-row sample — all fake by construction, safe to send anywhere | Sessions 5–7, A3 |
...
The `.devcontainer/` folder is what makes your Codespace arrive ready-made: Python, the notebooks support, and the **Codex** and **Claude Code** sidebar extensions are preinstalled — you just sign in.
